...
public class GridAdapter3 extends BaseAdapter {
    ...
    public void setOnclick(GridAdapter.Click click) {
        this.click = click;
    }

    public GridAdapter3(Context context, ArrayList<QBFW> qbfws) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position == 9) {
            ...
            viewHolder.tv_fwm.setText("全部服务");
        } else {
            ...
            viewHolder.iv_fwt.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    click.Clicks(position, qbfws.get(position).getServiceName());
                }
            });
        }
